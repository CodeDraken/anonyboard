...
export const UPDATE_THREAD_REQUEST = 'EDIT_THREAD_REQUEST'
export const UPDATE_THREAD_SUCCESS = 'EDIT_THREAD_SUCCESS'
export const UPDATE_THREAD_FAILURE = 'EDIT_THREAD_FAILURE'
